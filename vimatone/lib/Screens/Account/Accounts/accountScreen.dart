...
import 'package:vimatone/Screens/Account/SharedPreference/sharedpreference.dart';
...
class _AccountscreenState extends State<Accountscreen>
  ...
  Future<void> _checkLoginStatus() async {
    loggedIn = await UserPreferences.isLoggedIn();
    // if (!loggedIn) {
                                        ...
                                        child: GridView.count(
                                          ...
                                          children: List.generate(
                                            ...
                                            (index) {
                                              ...
                                              return ProductTile(
                                                image: (baseUrl +
                                                    explodeImages(_product
                                                        .thumbnail_id!)[0]),
                                                title: _product.title,
                                                price: "${_product.sale_price}",
                                                priceStroke: _product
                                                            .sale_price !=
                                                        null
